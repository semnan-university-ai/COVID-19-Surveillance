...
# ### <p style=color:blue>Naive bayes for Divorce Predictors Data Set</p>
# 
...
# #### Result:
# So we have successfully trained our dataset into Naive bayes for predicting whether a couple will get divorced or not. And also got the accuracy & confusion matrix for Naive bayes
